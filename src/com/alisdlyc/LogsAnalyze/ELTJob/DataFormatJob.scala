package com.alisdlyc.LogsAnalyze.ELTJob

import com.alisdlyc.LogsAnalyze.Utils.TimeDateFormatUtil
import org.apache.spark.{SparkConf, SparkContext}

/**
 * step 1
 */
object DataFormatJob {
	def main(args: Array[String]): Unit = {
		...
		val textRDD = sc.textFile("/Users/alisdlyc/IdeaProjects/SparkSQL/src/com/alisdlyc/LogsAnalyze/Data/page_view_data.log")
